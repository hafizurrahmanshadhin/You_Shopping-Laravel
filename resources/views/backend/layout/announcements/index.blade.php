                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Setup your system, please provide your<code>provide your valid
                                data</code>.</p>
                        <div style="display: flex;justify-content: end;"><a href="{{ route('announcement.create') }}"
                                class="btn btn-primary">Add Announcement</a></div>
...
@push('script')
    ...
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('announcement.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('announcement.destroy', ':id') }}';
