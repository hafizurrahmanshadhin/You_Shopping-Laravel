    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Latest Video</h4>
                        <p class="card-description">Setup your system, please provide your<code>provide your valid
                                data</code>.</p>
                        <div style="display: flex;justify-content: end;"><a href="{{ route('latest_video.create') }}"
                                class="btn btn-primary">Add Latest Video</a></div>
...
@push('script')
    ...
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('latest_video.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('latest_video.destroy', ':id') }}';
