...
@section('title', 'Create Sales Goal')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Create Sales Goal</h4>
                        <p class="card-description">Setup Mainstream Entertainment, please provide your <code>valid
                                data</code>.</p>
                        <div class="mt-4">
                            <form class="forms-sample" action="{{ route('sales.goal.store') }}" method="POST">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <input type="number" required
                                        ...
                                        placeholder="Please enter your Sales Target" name="sales_target" id="sales_target"
