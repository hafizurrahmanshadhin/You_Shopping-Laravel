                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Setup your system, please provide your<code>provide your valid
                                data</code>.</p>
                        <div style="display: flex;justify-content: end;"><a href="{{ route('sales.goal.create') }}"
                                class="btn btn-primary">Add Sales Goal</a></div>
...
@push('script')
    ...
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('sales.goal.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('sales.goal.destroy', ':id') }}';
