                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Setup your system, please provide your<code>provide your valid
                                data</code>.</p>
                        <div style="display: flex;justify-content: end;"><a href="{{ route('upcomingproject.create') }}"
                                class="btn btn-primary">Add Upcoming Project</a></div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('upcomingproject.index') }}",
                        type: "get",
                    },
        ...
        function statusChange(id) {
            let url = '{{ route('upcomingproject.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('upcomingproject.destroy', ':id') }}';
