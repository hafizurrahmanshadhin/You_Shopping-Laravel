    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Create Upcoming Project</h4>
                        <p class="card-description">Setup Mainstream Entertainment, please provide your <code>valid
                                data</code>.</p>
                        <div class="mt-4">
                            <form class="forms-sample" action="{{ route('upcomingproject.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" required
                                        ...
                                        name="releas_date" id="releas_date" value="{{ old('releas_date') }}">
                                    @error('releas_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
