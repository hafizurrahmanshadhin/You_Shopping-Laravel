...
@section('title', 'mainstream entertainment')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Mainstream Entertainments</h4>
                        <p class="card-description">Setup your system, please provide your<code>provide your valid
                                data</code>.</p>
                        <div style="display: flex;justify-content: end;">
                            <a href="{{ route('mainstream.entertainment.create') }}" class="btn btn-primary">Add
                            </a>
                        </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('mainstream.entertainment.index') }}",
                        type: "get",
                    },
        ...
        function statusChange(id) {
            var url = '{{ route('mainstream.entertainment.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            var url = '{{ route('mainstream.entertainment.destroy', ':id') }}';
